    ...
    <div className='main-div'>
      ...
      <div className='titulo'>
        ...
        <p className='introducao'>
          O Chef de Cozinha (CPU) é incrivelmente rápido, mas ele tem um problema: ele só entende um idioma estranho. Dessa forma, não tem como entregar uma receita escrita em português (ou linguagens de alto nível como C ou Python). É necessário escrever no idioma dele.
        </p>
      </div>
      ...
      <div className='exp1-modulo2'>
        <div>
            ...
            <br />
            <p>Assim como humanos possuem línguas diferentes, cada computador foi projetado para receber e interpretar instruções de uma maneira específica. <strong>A maneira como cada computador executa cada comando é baseada na arquitetura do seu conjunto de instruções</strong>, também chamada de ISA.</p>
        </div>
        ...
        <div>
          <p>Como é muito difícil escrever usando esse idioma do computador, escrevemos nossas receitas (códigos) em linguagens mais fáceis - chamamos de linguagem de alto nível - e usamos um tradutor automático, que chamamos de <strong>Compilador</strong>.</p>
        </div>
      </div>
      ...
      <div className='exp1-modulo2'>
        ...
        <br />
        <p>Você já deve ter ouvido falar que computadores usam apenas 0s e 1s para realizar todas suas operações. Isso se chama <strong>código binário</strong>, e, no fim, as instruções que o computador recebe são assim, realmente compostas desses dois números apenas!</p>
        <br />
        <div className='exp1-sub-modulo2'>
          <div>
